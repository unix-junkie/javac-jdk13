...
public final class SubtractExpression extends BinaryArithmeticExpression {
	...
	public SubtractExpression(final long l, final Expression expression, final Expression expression1) {
		super(30, l, expression, expression1);
	}
	...
	void codeOperation(final Environment environment, final Context context, final Assembler assembler) {
		assembler.add(this.where, 100 + this.type.getTypeCodeOffset());
	}
}
