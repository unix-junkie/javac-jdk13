...
public final class ShiftLeftExpression extends BinaryShiftExpression {

	public ShiftLeftExpression(final long l, final Expression expression, final Expression expression1) {
		super(26, l, expression, expression1);
	}
	...
	void codeOperation(final Environment environment, final Context context, final Assembler assembler) {
		assembler.add(this.where, 120 + this.type.getTypeCodeOffset());
	}
}
