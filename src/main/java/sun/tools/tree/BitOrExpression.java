...
public final class BitOrExpression extends BinaryBitExpression {

	public BitOrExpression(final long l, final Expression expression, final Expression expression1) {
		super(16, l, expression, expression1);
	}
	...
	void codeOperation(final Environment environment, final Context context, final Assembler assembler) {
		assembler.add(this.where, 128 + this.type.getTypeCodeOffset());
	}
}
