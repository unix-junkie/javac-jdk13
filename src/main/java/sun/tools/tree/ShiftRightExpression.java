...
public final class ShiftRightExpression extends BinaryShiftExpression {

	public ShiftRightExpression(final long l, final Expression expression, final Expression expression1) {
		super(27, l, expression, expression1);
	}
	...
	void codeOperation(final Environment environment, final Context context, final Assembler assembler) {
		assembler.add(this.where, 122 + this.type.getTypeCodeOffset());
	}
}
